...
export default function CollectionsPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Collections | DCTOH</title>

        <meta
          name="description"
          content="Explore DCTOH developer streetwear collections. Hoodies, oversized t-shirts, and cyberpunk outfits inspired by coding culture."
        />

        <meta
          name="keywords"
          content="developer hoodies, coding t shirts, techwear, programmer fashion"
        />

        <link rel="canonical" href="https://dctoh.vercel.app/collections" />
      </Helmet>
